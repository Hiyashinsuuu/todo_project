...
urlpatterns = [
    ...
    path('api/users/password-reset-confirm/<token>/', PasswordResetConfirmView.as_view(), name='password-reset-confirm'),
    path('accounts/', include('allauth.urls')), 
    path('api/users/verify-email/<token>/', VerifyEmailView.as_view(), name='email-verify'),
